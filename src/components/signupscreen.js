...
import { View, Text, TextInput, Alert, Image, TouchableOpacity, useColorScheme } from 'react-native';
...
import styles from '../../src/global-styles/sigunp.styles';
...
const Signup = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <TouchableOpacity style={styles.arrow} onPress={() => navigation.navigate('LetsIn')}>
                <AntDesign name="arrowleft" size={26} color={arrowColor} />
            </TouchableOpacity>

            <Text style={[styles.text, { color: theme.colors.text }]}>Create your Account</Text>
            ...
            <TouchableOpacity style={styles.signinbuton} onPress={handleSignUpPress}>
            ...
            <View style={styles.socailcont}>
                <TouchableOpacity>
                    <View style={[styles.fbcont, { backgroundColor: theme.colors.googlebutton }]}>
                        <View style={styles.fbwhite}></View>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('EditPtofile')}>
                    <View style={[styles.fbcont, { backgroundColor: theme.colors.googlebutton }]}>
