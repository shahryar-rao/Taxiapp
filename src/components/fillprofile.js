    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View style={styles.imagpickercont}>
                {imageUri ? (
                    <Image source={{ uri: imageUri }} style={styles.userpic} resizeMode="cover" /> // Display selected image
                ) : (
                    <Image source={require('../../assets/newuser.jpg')} style={styles.userpic} resizeMode="cover" />
                )}
                <TouchableOpacity style={styles.picimagebtn} onPress={() => pickImage(setImageUri)}>
                    <FontAwesome name="pencil-square" size={wp('8%')} color="#FFC12E" />
                </TouchableOpacity>
            </View>
